      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <a 
                href="https://linkedin.com/in/mohmmad-amine-hra-142986364" 
                target="_blank" 
        ...
        <div className="border-t border-border/30 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          ...
          <div className="mt-4 md:mt-0">
            Built with React & Tailwind CSS & <a href="https://lovable.dev" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-accent transition-colors">Lovable</a>
          </div>
        </div>
      </div>
    </footer>
